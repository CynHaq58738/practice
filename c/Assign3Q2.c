 ...
 * with the modification of getting an input from the user and storing it into list1
 * 
 * @name Cynthia Haque
 * @date 5-27-2024
 * @version 2024 CS2263
...
int main()
{
    ...
    char *list2 = (char*) malloc(10 * sizeof(char));
    ...
    //read in from memory a word from the user and store it into list1
    printf("Enter a word: \n");
    scanf("%9s", list1);
